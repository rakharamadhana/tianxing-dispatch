<script setup>
/**
 * Simple line-icon set. Follows DESIGN.md icon rules:
...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'payroll'">
    ...
    <template v-else-if="name === 'maintenance'">
    ...
    <template v-else-if="name === 'resort'">
      <polyline points="21 8 3 8" />
